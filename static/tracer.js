...
class HandlerTracer {
    ...
    generateAstBasedPayloads(staticAnalysisData, vulnerabilityAnalysis) {
        log.debug("[AST Payload Gen] Received static data:", JSON.stringify(staticAnalysisData));
        const generatedPayloads = [];
        ...
        if (!staticAnalysisData || !vulnerabilityAnalysis) {
            log.debug("[AST Payload Gen] Exiting: Invalid input data.");
            return [];
        }
        ...
        log.debug("[AST Payload Gen] All considered accessed paths:", Array.from(accessedPaths));
        ...
        log.debug("[AST Payload Gen] Detected message type fields:", typeFields);
        ...
        log.debug("[AST Payload Gen] Path to Sink Map:", Object.fromEntries(pathToSinkMap));


        const requiredConditions = staticAnalysisData.requiredConditions || {};
        log.debug("[AST Payload Gen] General required conditions:", JSON.stringify(requiredConditions));
